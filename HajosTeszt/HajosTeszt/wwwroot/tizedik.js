...
function init() {
    ...
    fetch("questions/count")
        .then(result => restult.text())
        .then(ne => { numberOfQuestions = parseInt(n) })

    documnet.getElementById("előre_gomb").addEventListener("click", előre);
    documnet.getElementById("vissza_gomb").addEventListener("click", vissza);
